...
class CollegeFootballData
{
    ...
    public function roster(?RosterParameters $parameters = null): array
    {
        $response = $this->request('roster', $parameters?->toQueryString());

        return $this->serializer->denormalize($response, Player::class. '[]');
    }
}
